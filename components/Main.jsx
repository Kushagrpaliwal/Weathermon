  ...
  const weather = {
    ...
    city1: function (city) {
      fetch(
        ...
        return response.json();
      }).then((data) => this.displayCity(data, 1));
    },
    city2: function (city) {
      fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${this.apikey}`
        ...
        return response.json();
      }).then((data) => this.displayCity(data, 2));
    },
    city3: function (city) {
      fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${this.apikey}`
        ...
        return response.json();
      }).then((data) => this.displayCity(data, 3));
    },
    city4: function (city) {
      fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${this.apikey}`
        ...
        return response.json();
      }).then((data) => this.displayCity(data, 4));
    },
    ...
    displayCity: function (data, cityIndex) {
      if (typeof document !== 'undefined') {
        const { name } = data;
        const { icon, description } = data.weather[0];
        const temp = data.main.temp;
        document.querySelector(`.city${cityIndex}name`).innerHTML = name;
        document.querySelector(`.city${cityIndex}icon`).src = `http://openweathermap.org/img/wn/${icon}.png`;
        document.querySelector(`.city${cityIndex}description`).innerHTML = description;
        document.querySelector(`.city${cityIndex}temp`).innerHTML = `${temp}°C`;
      }
    },
    search: function () {
      if (typeof document !== 'undefined') {
      ...
      <div className={`min-h-screen overflow-hidden p-5 ${toggle ? 'text-white' : 'text-black'}`}>
        <div className="flex flex-col lg:flex-row h-full w-full space-y-10 lg:space-y-0 lg:space-x-10 lg:pl-[100px] mt-[100px]">
          <div className="flex flex-col w-full p-5">
            <div className="flex justify-center font-light mb-1 date">Full Date</div>
              ...
              <div className="font-light">
                ...
                <div className="flex flex-row resttxt">
                  <div className="w-1/2 p-4">
                    <div className="mb-2">
                      <div className="flex flex-row">
                        ...
                        <p className="feels">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Gust</p>
                        <p className="gust">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Maximum Temperature</p>
                        <p className="maxtemp">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                  ...
                  <div className="w-1/2 p-4">
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Wind Speed</p>
                        <p className="windspeed">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Pressure</p>
                        <p className="pressure">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Wind Direction</p>
                        <p className="windD">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                    <div className="mb-2">
                      <div className="flex flex-row">
                        <p className="w-full">Clouds</p>
                        <p className="cloudes">hello</p>
                      </div>
                      <hr className="border-gray-300 mt-2" />
                    </div>
                  </div>
          ...
          <div className="flex flex-col w-full lg:w-2/4 h-auto font-light">
            <div className="flex justify-center font-light mb-1">Weather Around the World</div>
